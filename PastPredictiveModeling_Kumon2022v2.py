...
~ This version last updated: 21 August 2025 ~
...
2. Prepare your data by cleaning and pre-processing a .csv file:
   ...
   - The dependent variable (e.g. "wage") should NOT be scaled
...
EXPECTED OUTPUTS:
  1. ''Output.csv' (or whatever you choose to call it): Main results file with model fit score, predictions, and (optionally) bootstrap standard errors for all subgroups
...
path  = '/Users/merpaker/Documents/PythonFTP/PMTP_Final/ReplicationFiles/PPM Upload'

# 2. Change this to the name of your CSV file
# -- Include the extension .csv
filename ='CleanJapanData.csv'

# 3. Change this to the path to the directory where you want the results to be saved
# -- Use the FULL path to the directory, for example:
# ----- On Mac/Linux: '/Users/YourUsername/Documents/YourProjectFolder'
# ----- On Windows: 'C:\\Users\\YourUsername\\Documents\\YourProjectFolder'
# -- Note that this can be the same directory as above, or a different directory
path2 = '/Users/merpaker/Documents/PythonFTP/PMTP_Final/ReplicationFiles/PPM Upload/Output'

# 4. Change this to the name you would like your output saved as
# -- Include the extension .csv
filename2 ='JapanOutput.csv'

# 5. Change this to the name of the column in your dataset representing the outcome variable 
...
outcome_var = 'fullpayment'

# 6. Is your outcome variables logged? Set this to 1 if so, or 0 otherwise
...
# 7. Change this to the name of the column in your dataset representing the year variable
year_id = 'year'

# 8. List here the names of any columns that should NOT be included in the model
...
# 9. Change these values to the start and end years you would like to use for the analysis
year_start = 1610
year_end = 1890

# 10. Determine how many years of additional data you require for the latest (most recent prediction)
...
# -- In cases where data are completely missing for the training, testing, validation, or prediction sample, no
# estimate is generated for that year
years_extra = 40


# 11. Change this feature importance flag to 1 to get feature importance results and 0 to skip
# -- Note that computing the feature importance results makes the analysis run more slowly
feature_importance = 0

# 12. Change this boostrap standard error flag to 1 to generate bootstrap standard errors and 0 to skip
# -- Note that computing bootstrap standard errors makes the analysis run more slowly
use_bootstrap = 1

# 13. Define subsets of the data for which you want different predictions
...
# -- Note that these categorical variables can have any number of categories
...
# Otherwise, leave this set to none
...
import ppm_backendv2
ppm_backendv2.run_pmtp(year_start, year_end, years_extra, 2000, path, filename, path2, filename2, year_id, outcome_var, outcome_logged, exclude_vars, feature_importance, split1, split2, lgb_params, use_bootstrap, 100)
